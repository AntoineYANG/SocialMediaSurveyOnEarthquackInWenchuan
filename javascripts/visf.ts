...
namespace Visf {
        ...
        */
        export class Axis2d extends Axis {
            ...
            */
             ...
             * @memberof Axis2d
             */
            public xScale(style: string, content: any = null): Axis2d {
                ...
                if (style == 'ordinal') {
                    (<Scale.OrdinalScale><any>this.scale_x).among(< Array<number> ><any>content);
                    this.X_domain_list = content;
                }
                else if (style == 'log') {
                    (<Scale.LogScale><any>this.scale_x).base(<number><any> content);
                }
                else if (style == 'power') {
                    (<Scale.PowerScale><any>this.scale_x).base(<number><any>content);
                }
                this.update();
                return this;
            }
             ...
             * @memberof Axis2d
             */
            public yScale(style: string, content: any = null): Axis2d {
                ...
                if (style == 'ordinal') {
                    (<Scale.OrdinalScale><any>this.scale_y).among(content);
                    this.Y_domain_list = content;
                }
                else if (style == 'log') {
                    (<Scale.LogScale><any>this.scale_y).base(<number><any> content);
                }
                else if (style == 'power') {
                    (<Scale.PowerScale><any>this.scale_y).base(<number><any>content);
                }
                this.update();
                return this;
            }
    ...
    export namespace Scale {   
        ...
        */
        export class LogScale implements Scale {
            ...
            * @memberof LogScale
            */
            domain(min: number, max: number): LogScale {
                this.domain_min = min;
                this.domain_max = max;
                return this;
            }
            ...
            * @memberof LogScale
            */
            range(min: number, max: number): LogScale {
                this.range_min = min;
                this.range_max = max;
                return this;
            }
            ...
            */
            to(val: number): number {
                ...
                let num = Math.log((val - this.domain_min) * (this._base - 1) / (this.domain_max - this.domain_min) + 1)
        ...
        */
        export class PowerScale implements Scale {
            ...
            * @memberof PowerScale
            */
            domain(min: number, max: number): PowerScale {
                this.domain_min = min;
                this.domain_max = max;
                return this;
            }
            ...
            * @memberof PowerScale
            */
            range(min: number, max: number): PowerScale {
                this.range_min = min;
                this.range_max = max;
                return this;
            }
             ...
             *Sets the base of the pow.
                ...
                * @memberof PowerScale
                */
            public base(b: number): PowerScale {
                this._base = b;
                return this;
            }
            ...
            */
            to(val: number): number {
                ...
                let num = (Math.pow(this._base, (val - this.domain_min) / (this.domain_max - this.domain_min)) - 1)
    ...
    export namespace Struct {
        ...
        export class Cube {
             ...
             * @memberof Cube
             */
            public add(obj: Array<object>): Cube {
                for (let i in obj) {
                    let o: object = obj[i];
                    if (o['value'] == null)
                        continue;
                    let m: object = {value: o['value']};
             ...
             * @memberof Cube
             */
            public displayOn(axis: Axis.Axis2d): boolean {
                ...
                let x_min: number = this.data[0][this.label[0]];
             ...
             * @memberof Cube
             */
            public filter(callback: (e: object) => boolean): Cube {
                let c: Cube = new Cube(this.label);
                this.data.forEach(d => {
                    if (callback(d))
                        c.add([d]);
                });
